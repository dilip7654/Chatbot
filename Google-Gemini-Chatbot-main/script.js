...
const API_KEY = "AIzaSyAVKXP9jUWA9aQRng-k3AJ2d8_bWCJ8plQ"; // Replace with your actual API key
...
const loadDataFromLocalstorage = () => {
  ...
  document.body.classList.toggle("hide-header", !!savedChats); // Use !! to coerce to boolean
